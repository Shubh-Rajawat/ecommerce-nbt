...
const Profile = () => {
    return (
        <>
            ...
            <div className='w-[100%] md:ss-container px-1 py-5 md:py-12 flex justify-center'>
                <div className="w-full md:w-[60%] lg:w-[55%] xl:w-[44%] h-full bg-[#F2F2F2] px-5  md:px-7 pt-10 rounded-3xl">
                    <div
                        ...
                        <div className="">
                            <span className="">
                                <img src={ `https://bit.ly/dan-abramov` } alt="" className="h-28 md:h-40 rounded-full "
                                    style={ {
                            ...
                            <div className="mt-3">
                                ...
                                <div className=" flex items-center gap-4 popins text-[16px] md:text-[18px] my-2 ">
                                    <div className="bg-[#D63348] text-white rounded-full">
                                        <ImLocation className="text-[18px] md:text-[20px] m-2" size={ 22 } />
                                    </div>
                    ...
                    </div>
                    {
                        data.map( item => {
                            return (
                                <SmallCard key={ item.name } data={ item } />
                            )
                        } )
                    }
